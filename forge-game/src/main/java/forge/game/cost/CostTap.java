...
public class CostTap extends CostPart {
    ...
    @Override
    public final boolean canPay(final SpellAbility ability, final Player player, final boolean effect) {
        final Card source = ability.getHostCard();
        return source.isUntapped() && (!isAbilitySick(source) || player.getController().canPlayUnlimited());
    }
